export const bullets = {
  ...
  2: {
    class: 'flex pointer-cursor pl-4',
  ...
  3: {
    class: 'flex pointer-cursor pl-8',
  ...
  4: {
    class: 'flex pointer-cursor pl-12',
  ...
  5: {
    class: 'flex pointer-cursor pl-16',
  ...
  6: {
    class: 'flex pointer-cursor pl-20',
...
export const content = ({ value, depth, url }) => {
  ...
  return (
    <a className={bullets[depth].class} key={url} href={url}>
      ...
      <p className={bullets[depth].textClass}>{value.length > limit ? value.slice(0, limit) + '...' : value}</p>
    </a>
  )
}
