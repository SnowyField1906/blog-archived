export const bullets = {
  ...
  5: {
    ...
    textClass:
      'my-auto hover:underline text-primary-600 dark:text-primary-400 font-normal text-[0.85rem]',
    bulletClass:
      'font-sans my-auto text-primary-600 dark:text-primary-400 mr-2 font-medium text-[0.85rem]',
    symbol: '◈',
  },
  5: {
    class: 'truncate flex pointer-cursor pl-12',
