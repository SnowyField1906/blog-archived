...
export default function NowPlaying() {
  ...
  return (
    <div className="mb-8 flex w-full cursor-pointer flex-row items-center gap-4 rounded-md border border-zinc-200 bg-zinc-200 px-4 py-2 text-sm shadow-sm dark:border-zinc-900 dark:bg-zinc-900 dark:shadow-none sm:py-4">
      {data?.songUrl ? (
        <AnimatedBars />
      ) : (
