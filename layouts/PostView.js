        ...
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          ...
          >
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="prose max-w-none pt-10 pb-8 font-cambria first-letter:float-left first-letter:mr-10 first-letter:font-serif first-letter:text-[6.56295rem] first-letter:font-semibold first-letter:leading-none dark:prose-dark">
                {children}
              </div>
