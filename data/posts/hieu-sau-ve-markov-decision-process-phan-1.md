...
Khuyến nghị đọc trước [Giới thiệu về Markov Chain và ứng dụng](https://archive.snowyfield.me/posts/gioi-thieu-ve-markov-chain-va-ung-dung) để sẵn sàng trước khi đi vào bài viết này.
...
Còn đối với việc truy xuất thông qua $a$, mỗi Action sẽ tương ứng với một [Transition Matrix](https://en.wikipedia.org/wiki/Stochastic_matrix) (Ma trận Chuyển tiếp) như trong [Markov Chain](https://archive.snowyfield.me/posts/gioi-thieu-ve-markov-chain-va-ung-dung), thể hiện quá trình chuyển đổi qua lại giữa các State.
