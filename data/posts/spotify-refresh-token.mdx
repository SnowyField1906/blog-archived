...
thumbnail: '/static/images/posts/spotify-refresh-token.jpg'
---

<img
  className="inline rounded-lg"
  src="/static/images/posts/spotify-refresh-token.jpg"
  alt="Spotify Logo"
/>
...
I needed the Spotify Refresh Token for my blog site in which I could display my [Top 10 Tracks](https://blog-snowyfield.vercel.app//stats) as well as display the currently playing track in the footer section.
...
<div className="grid place-items-center">
  <img
    className="inline rounded-lg"
    src="/static/images/posts/Spotify-Callback-URL.png"
...
- You will be redirected to your redirect URI which in my case was set to *https://blog-snowyfield.vercel.app//callback*.
...
- In the address bar you will find a huge URL string similar to the one below. In place of `$ACCESSCODE` there will be a long string of characters. Note down that string for the next step.
  ...
  ```bash
  https://blog-snowyfield.vercel.app//callback?code=$ACCESSCODE
  ```
